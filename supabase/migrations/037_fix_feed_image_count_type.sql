-- Fix get_feed and get_following_feed: cast image_count to INTEGER
-- to match declared return type (meals.image_count is SMALLINT)
...
-- Fix get_following_feed similarly
